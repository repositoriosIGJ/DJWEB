...
{
    public partial class LibrosBal : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ucFechaRUB.proplblFecha = "Fecha Ultima Registración";
                CargarCombos();
                CargarLibroVacio();
        ...
        protected void GuardarLibro()
        {
            try
            {
                ...
                LIB.has = txtHashRUB.Text.Trim() == "" ? "N/C" : txtHashRUB.Text.Trim();
                    ...
                    if (oLibros.libros != null)
                    {
                        ...
                        foreach (var item in oLibros.libros)
                        {
                            if (item.iddoc == iddocsel)
                            {
                                ...
                                txtHashRUB.Text = (item.has.ToString().ToLower().Trim() == "n/c" ? "" : item.has);
                            }
                        }
                    }
                }
        ...
        public bool ValidarMinimo()
        {
            ...
            foreach (var item in oLibros.libros)
            {
                if (item.den != "N/C" || item.nru != "N/C" || item.fru != "N/C" || item.has != "N/C")
                {
