<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucVinculoPEP.ascx.cs" Inherits="DJEngine.App_Controls.ucVinculoPEP" %>

    <tr>
            <td align="right">
                <asp:Label ID="lblVinculoPEP" runat="server" Width="210px">Vinculo/Relacion con la persona expuesta politicamente</asp:Label>
            </td>
            <td align="left">
