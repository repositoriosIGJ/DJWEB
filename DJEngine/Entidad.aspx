<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DJ.Master" AutoEventWireup="true" CodeBehind="Entidad.aspx.cs" Inherits="DJEngine.WebEntities.Entidad" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterPage" runat="server">
                ...
                <div class="DJCuadroCentro">
                    <div class="DJCuadroConstituida">
                        <asp:RadioButtonList ID="rblConstituida" runat="server" AutoPostBack="True" 
                            ...
                            <asp:ListItem Text="Buscar Entidad Constituida" Value="1" Selected="True"></asp:ListItem>
                            <asp:ListItem Text="Ingresar Entidad No Constituida" Value="2"></asp:ListItem>                                                              
                        </asp:RadioButtonList>
                     </div>
                </div>
        ...
        <asp:Panel ID="pnlwfk_2" runat="server" BackImageUrl="/imagenes/" Visible="False">
                ...
                <div class="DJCuadroCentro">                                   
                    <%--<uc1:ucBuscadorEnt ID="ucBuscadorEntEntidad" runat="server"  OnBuscarNroCorr ="ucBuscadorEntEntidad_BuscarNroCorr"/>--%>
        ...
        <asp:Panel ID="pnlwfk_3" runat="server">
                <div class="DJCuadroHeader">
                    ...
                    <asp:Label ID="LblTitulo_3" class="CuadroTitulo" runat="server" Width="700px">Datos de la Entidad No Constituida</asp:Label>
                </div>
                <div class="DJCuadroCentro">                 
                        <table cellspacing="10px">
                            <tr>
