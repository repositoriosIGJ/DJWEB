<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DJ.Master" AutoEventWireup="true"
    CodeBehind="LibrosBal.aspx.cs" Inherits="DJEngine.WebEntities.LibrosBal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterPage" runat="server">
    ...
    <asp:Panel ID="pnlwfk_3" runat="server">
        <div class="DJCuadroHeader">
            ...
            <asp:Label ID="LblTitulo_3" class="CuadroTitulo" runat="server" Width="700px">Datos del Libro Digital</asp:Label>
        </div>
        <div class="DJCuadroCentro">
            <table cellspacing="10px">
                <tr>
                    <td align="right">
                        <asp:Label ID="lblDocRubrica" runat="server" Width="240px">Seleccione el Documento</asp:Label>
                    </td>
                    <td align="left">
        ...
        <div class="DJCuadroCentro">
            <table cellspacing="10px">
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblNumeroRUB" runat="server" Width="200px">Número RL</asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblHashRUB" runat="server" Width="200px">Hash</asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtHashRUB" class="txteffect" runat="server" Width="410px" Font-Size="11px" MaxLength="64"></asp:TextBox>
                        <asp:CustomValidator ID="cvHashRUB" runat="server" ErrorMessage="&lt;img src=&quot;/App_Theme/Imagenes/imgAsterisco.png&quot;/&gt;"
                            ControlToValidate="txtHashRUB" Display="Dynamic" EnableClientScript="False"
                            OnServerValidate="CustomValidator_Standar" ValidateEmptyText="True" CssClass="imgCruz"></asp:CustomValidator>
                        <br />
                    </td>
                </tr>
        ...
        <asp:GridView ID="grdLibros" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
            ...
            <Columns>
                <asp:BoundField DataField="doc" HeaderText="Documento o Estado Digital Presentado" />
                <asp:BoundField DataField="den" HeaderText="Denominación" />
                <asp:BoundField DataField="nru" HeaderText="Número RL" />
                <asp:BoundField DataField="fru" HeaderText="Ultima Registración" />
                <%--<asp:BoundField DataField="fol" HeaderText="Folios" />--%>
                <asp:BoundField DataField="has" HeaderText="Hash" ItemStyle-CssClass="grdbfhash" ItemStyle-Font-Size="10px" />
            </Columns>
